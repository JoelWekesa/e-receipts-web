...
const AddTeamComponent: FC<Props> = ({stores, permissions, close}) => {
			...
			<Form {...form}>
				<form onSubmit={form.handleSubmit(handleSubmit)}>
					<DialogHeader>
						...
						<DialogDescription>Add a new team to manage your store</DialogDescription>
					</DialogHeader>
					<div>
					...
					<DialogFooter>
						...
						<Button type='submit' disabled={isPending}>
							{isPending && <Loader2 className='mr-2 h-4 w-4 animate-spin' />}Add Team
						</Button>
					</DialogFooter>
				</form>
			</Form>
