...
import useCashTopUp from '@/services/float/top-up-cash';
...
const AddCashDialog: FC<Props> = ({open, onClose, storeCash}) => {
	...
	const {mutate: topUp, isPending} = useCashTopUp(successFn);
			...
			<DialogContent className='w-3/4'>
				<Form {...form}>
					<form onSubmit={form.handleSubmit(handleSubmit)}>
						<DialogHeader>
							<DialogTitle>Top Up Cash</DialogTitle>
